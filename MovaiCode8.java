...
public class MovaiCode8{
    ...
    public static <E> E[] mange_une_crepe(E[] pile_de_crepes) throws Exception{
        ...
        // les classes de la fonction
            ...
            */
            class Iterateur {
                ...
                */
                public void aUnSuivant() throws CrepeExeptionnelle {nous permet de savoir si la crêpe actuelle a une crêpe au dessus
                    if (index >= nombre_de_crepe - 1) throw new CrepeExeptionnelle();//ça throw une crepe raté si jamais il y en a plus, sinon tout va bien
                }
        ...
        try{//un try parce qu'ici on fait avec des CrepesExceptionnelles
            Stack<E> stack = new Stack<>();//on créer une pile pour notre pile de crêpe
            ...
            while (true){//ici on n'en sort qu'Exceptionnellement (via le catch de l'Exception qui sera retourné par aUnSuivant();
                ...
                try{ iterateur.suivant(); }//va chercher la crêpe suivante
    ...
    public static void main(String[] args) throws Exception {
        ...
        Integer[] array2 = <Integer>mange_une_crepe(array);//array2==array, on réutilise la même assiette, gare à la vaisselle
        //array2 = {0,1,2}
    }
}
